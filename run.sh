...
# python train_interaction.py -experiment Debug -train -docker -batch_size 8 -num_epochs 1
...
#ResNet docking
# python train_docking.py -experiment Debug -resnet -num_epochs 1 -batch_size 32 -gpu 1
# python train_docking.py -experiment CNNDocking -train -resnet -num_epochs 100 -batch_size 32 -gpu 1

#ResNet interaction
# python train_interaction.py -experiment Debug -train -resnet -batch_size 32 -num_epochs 1
