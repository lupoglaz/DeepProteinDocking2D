...
#SBATCH --job-name=eval_biasF_unfrozen_1rep
#SBATCH --nodes=1
##SBATCH --ntasks=1
...
#SBATCH --output=slurm_log/slurm.%N.eval_biasF_unfrozen_1rep.out
#SBATCH --error=slurm_log/slurm.%N.eval_biasF_unfrozen_1rep.err
#SBATCH --export=ALL
