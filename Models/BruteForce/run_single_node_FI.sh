...
#SBATCH --job-name=2reps_6ep_scratch_final
#SBATCH --nodes=1
##SBATCH --ntasks=1
...
#SBATCH --output=slurm_log/slurm.%N.2reps_6ep_scratch_final.out
#SBATCH --error=slurm_log/slurm.%N.2reps_6ep_scratch_final.err
#SBATCH --export=ALL
