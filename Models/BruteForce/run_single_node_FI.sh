...
#SBATCH --job-name=F0lr0_scratch_reg_deltaF
#SBATCH --nodes=1
##SBATCH --ntasks=1
...
#SBATCH --output=slurm_log/slurm.%N.F0lr0_scratch_reg_deltaF.out
#SBATCH --error=slurm_log/slurm.%N.F0lr0_scratch_reg_deltaF.err
#SBATCH --export=ALL
