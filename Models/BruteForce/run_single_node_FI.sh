...
#SBATCH --job-name=10ep_F0lr0_expB_reg_deltaF
#SBATCH --nodes=1
##SBATCH --ntasks=1
...
#SBATCH --output=slurm_log/slurm.%N.10ep_F0lr0_expB_reg_deltaF.out
#SBATCH --error=slurm_log/slurm.%N.10ep_F0lr0_expB_reg_deltaF.err
#SBATCH --export=ALL
