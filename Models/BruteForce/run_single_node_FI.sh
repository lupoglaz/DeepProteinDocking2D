...
#SBATCH --job-name=10ep_lr1_nlse_sig_expB
#SBATCH --nodes=1
##SBATCH --ntasks=1
...
#SBATCH --output=slurm_log/slurm.%N.10ep_lr1_nlse_sig_expB.out
#SBATCH --error=slurm_log/slurm.%N.10ep_lr1_nlse_sig_expB.err
#SBATCH --export=ALL
