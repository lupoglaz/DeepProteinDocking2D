...
#SBATCH --job-name=shiftednewEQ_lr0_sum_f0_scratch
#SBATCH --nodes=1
##SBATCH --ntasks=1
...
#SBATCH --output=slurm_log/slurm.%N.shiftednewEQ_lr0_sum_f0_scratch.out
#SBATCH --error=slurm_log/slurm.%N.shiftednewEQ_lr0_sum_f0_scratch.err
#SBATCH --export=ALL
