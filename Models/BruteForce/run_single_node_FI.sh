...
#SBATCH --job-name=resume_scratch_lr4_ones_final
#SBATCH --nodes=1
##SBATCH --ntasks=1
...
#SBATCH --output=slurm_log/slurm.%N.resume_scratch_lr4_ones_final.out
#SBATCH --error=slurm_log/slurm.%N.resume_scratch_lr4_ones_final.err
#SBATCH --export=ALL
