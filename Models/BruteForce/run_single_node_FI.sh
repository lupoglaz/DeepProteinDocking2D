...
#SBATCH --job-name=lr5_ones_scratch_final
#SBATCH --nodes=1
##SBATCH --ntasks=1
...
#SBATCH --output=slurm_log/slurm.%N.lr5_ones_scratch_final.out
#SBATCH --error=slurm_log/slurm.%N.lr5_ones_scratch_final.err
#SBATCH --export=ALL
