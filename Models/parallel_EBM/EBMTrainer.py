...
class EBMTrainer:
	...
	def step_parallel(self, data, epoch=None, train=True):
		...
		# 														 neg_lig_feat.detach(), neg_idx, sigma_dr=0.005,
		# 														 sigma_alpha=0.05)
		...
		# print('\nTraining =', train)
		neg_alpha, neg_dr = self.langevin(neg_alpha, neg_dr, neg_rec_feat.detach(), neg_lig_feat.detach(), neg_idx, 'cold')
		neg_alpha2, neg_dr2 = self.langevin(neg_alpha2, neg_dr2, neg_rec_feat.detach(), neg_lig_feat.detach(), neg_idx, 'hot')
	...
	def interaction_prediction(self, neg_rec_feat, neg_lig_feat ):
		plotting = True
		# plotting = False
		if epoch == 0:
			print(epoch, '*' * 100)
