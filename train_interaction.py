...
from Models import CNNInteractionModel, EQScoringModel, EQInteraction, SidInteraction, EQInteractionF, SharpLoss
...
if __name__=='__main__':
	...
	train_stream = get_interaction_stream_balanced('DatasetGeneration/interaction_data_train.pkl', batch_size=args.batch_size, max_size=10, shuffle=False)
	valid_stream = get_interaction_stream('DatasetGeneration/interaction_data_train.pkl', batch_size=args.batch_size, max_size=10)
	...
	if args.cmd() == 'train':
		for epoch in range(args.num_epochs):
			...
			Accuracy, Precision, Recall = test(train_stream, trainer, epoch=epoch)
